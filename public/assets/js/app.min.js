...
}]),angular.module("ui.bootstrap.carousel").run(function(){!angular.$$csp().noInlineStyle&&!angular.$$uibCarouselCss&&angular.element(document).find("head").prepend('<style type="text/css">.ng-animate.item:not(.left):not(.right){-webkit-transition:0s ease-in-out left;transition:0s ease-in-out left}</style>'),angular.$$uibCarouselCss=!0}),angular.module("ui.bootstrap.datepicker").run(function(){!angular.$$csp().noInlineStyle&&!angular.$$uibDatepickerCss&&angular.element(document).find("head").prepend('<style type="text/css">.uib-datepicker .uib-title{width:100%;}.uib-day button,.uib-month button,.uib-year button{min-width:100%;}.uib-left,.uib-right{width:100%}</style>'),angular.$$uibDatepickerCss=!0}),angular.module("ui.bootstrap.position").run(function(){!angular.$$csp().noInlineStyle&&!angular.$$uibPositionCss&&angular.element(document).find("head").prepend('<style type="text/css">.uib-position-measure{display:block !important;visibility:hidden !important;position:absolute !important;top:-9999px !important;left:-9999px !important;}.uib-position-scrollbar-measure{position:absolute !important;top:-9999px !important;width:50px !important;height:50px !important;overflow:scroll !important;}.uib-position-body-scrollbar-measure{overflow:scroll !important;}</style>'),angular.$$uibPositionCss=!0}),angular.module("ui.bootstrap.datepickerPopup").run(function(){!angular.$$csp().noInlineStyle&&!angular.$$uibDatepickerpopupCss&&angular.element(document).find("head").prepend('<style type="text/css">.uib-datepicker-popup.dropdown-menu{display:block;float:none;margin:0;}.uib-button-bar{padding:10px 9px 2px;}</style>'),angular.$$uibDatepickerpopupCss=!0}),angular.module("ui.bootstrap.tooltip").run(function(){!angular.$$csp().noInlineStyle&&!angular.$$uibTooltipCss&&angular.element(document).find("head").prepend('<style type="text/css">[uib-tooltip-popup].tooltip.top-left > .tooltip-arrow,[uib-tooltip-popup].tooltip.top-right > .tooltip-arrow,[uib-tooltip-popup].tooltip.bottom-left > .tooltip-arrow,[uib-tooltip-popup].tooltip.bottom-right > .tooltip-arrow,[uib-tooltip-popup].tooltip.left-top > .tooltip-arrow,[uib-tooltip-popup].tooltip.left-bottom > .tooltip-arrow,[uib-tooltip-popup].tooltip.right-top > .tooltip-arrow,[uib-tooltip-popup].tooltip.right-bottom > .tooltip-arrow,[uib-tooltip-html-popup].tooltip.top-left > .tooltip-arrow,[uib-tooltip-html-popup].tooltip.top-right > .tooltip-arrow,[uib-tooltip-html-popup].tooltip.bottom-left > .tooltip-arrow,[uib-tooltip-html-popup].tooltip.bottom-right > .tooltip-arrow,[uib-tooltip-html-popup].tooltip.left-top > .tooltip-arrow,[uib-tooltip-html-popup].tooltip.left-bottom > .tooltip-arrow,[uib-tooltip-html-popup].tooltip.right-top > .tooltip-arrow,[uib-tooltip-html-popup].tooltip.right-bottom > .tooltip-arrow,[uib-tooltip-template-popup].tooltip.top-left > .tooltip-arrow,[uib-tooltip-template-popup].tooltip.top-right > .tooltip-arrow,[uib-tooltip-template-popup].tooltip.bottom-left > .tooltip-arrow,[uib-tooltip-template-popup].tooltip.bottom-right > .tooltip-arrow,[uib-tooltip-template-popup].tooltip.left-top > .tooltip-arrow,[uib-tooltip-template-popup].tooltip.left-bottom > .tooltip-arrow,[uib-tooltip-template-popup].tooltip.right-top > .tooltip-arrow,[uib-tooltip-template-popup].tooltip.right-bottom > .tooltip-arrow,[uib-popover-popup].popover.top-left > .arrow,[uib-popover-popup].popover.top-right > .arrow,[uib-popover-popup].popover.bottom-left > .arrow,[uib-popover-popup].popover.bottom-right > .arrow,[uib-popover-popup].popover.left-top > .arrow,[uib-popover-popup].popover.left-bottom > .arrow,[uib-popover-popup].popover.right-top > .arrow,[uib-popover-popup].popover.right-bottom > .arrow,[uib-popover-html-popup].popover.top-left > .arrow,[uib-popover-html-popup].popover.top-right > .arrow,[uib-popover-html-popup].popover.bottom-left > .arrow,[uib-popover-html-popup].popover.bottom-right > .arrow,[uib-popover-html-popup].popover.left-top > .arrow,[uib-popover-html-popup].popover.left-bottom > .arrow,[uib-popover-html-popup].popover.right-top > .arrow,[uib-popover-html-popup].popover.right-bottom > .arrow,[uib-popover-template-popup].popover.top-left > .arrow,[uib-popover-template-popup].popover.top-right > .arrow,[uib-popover-template-popup].popover.bottom-left > .arrow,[uib-popover-template-popup].popover.bottom-right > .arrow,[uib-popover-template-popup].popover.left-top > .arrow,[uib-popover-template-popup].popover.left-bottom > .arrow,[uib-popover-template-popup].popover.right-top > .arrow,[uib-popover-template-popup].popover.right-bottom > .arrow{top:auto;bottom:auto;left:auto;right:auto;margin:0;}[uib-popover-popup].popover,[uib-popover-html-popup].popover,[uib-popover-template-popup].popover{display:block !important;}</style>'),angular.$$uibTooltipCss=!0}),angular.module("ui.bootstrap.timepicker").run(function(){!angular.$$csp().noInlineStyle&&!angular.$$uibTimepickerCss&&angular.element(document).find("head").prepend('<style type="text/css">.uib-time input{width:50px;}</style>'),angular.$$uibTimepickerCss=!0}),angular.module("ui.bootstrap.typeahead").run(function(){!angular.$$csp().noInlineStyle&&!angular.$$uibTypeaheadCss&&angular.element(document).find("head").prepend('<style type="text/css">[uib-typeahead-popup].dropdown-menu{display:block;}</style>'),angular.$$uibTypeaheadCss=!0});var chisel=angular.module("myApp",["ngRoute","ui.bootstrap","ngAnimate","angularFileUpload"]);chisel.config(function($routeProvider,$locationProvider,$httpProvider){$routeProvider.when("/home",{templateUrl:"html/home.html",controller:"homeController"}).when("/launch",{templateUrl:"html/launch.html",controller:"launchController"}).otherwise({redirectTo:"/home"}),$locationProvider.html5Mode(!0),$httpProvider.defaults.headers.common["X-Requested-With"]="XMLHttpRequest"}),chisel.factory("chisel_var",function(){var items={},itemsService={};return items.fonts=[{name:"Georgia",value:"Georgia, serif"},{name:"Palatino Linotype",value:'"Palatino Linotype", "Book Antiqua", Palatino, serif'},{name:"Times New Roman",value:'"Times New Roman", Times, serif'},{name:"Arial",value:"Arial, Helvetica, sans-serif"},{name:"Arial Black",value:'"Arial Black", Gadget, sans-serif'},{name:"Comic Sans MS",value:'"Comic Sans MS", cursive, sans-serif'},{name:"Impact",value:"Impact, Charcoal, sans-serif"},{name:"Lucida Sans Unicode",value:'"Lucida Sans Unicode", "Lucida Grande", sans-serif'},{name:"Tahoma",value:"Tahoma, Geneva, sans-serif"},{name:"Trebuchet MS",value:'"Trebuchet MS", Helvetica, sans-serif'},{name:"Verdana",value:"Verdana, Geneva, sans-serif"},{name:"Courier New",value:'"Courier New", Courier, monospace'},{name:"Lucida Console",value:'"Lucida Console", Monaco, monospace'}],itemsService.get=function(name){if(items[name])return items[name]},itemsService.id_to_obj=function(name,id){if(items[name]){var result=$.grep(items[name],function(e){return e.id==id});return 1==result.length?result[0]:{}}},itemsService}),chisel.directive("customOnChange",function(){return{restrict:"A",link:function(scope,element,attrs){var onChangeHandler=scope.$eval(attrs.customOnChange);element.bind("change",onChangeHandler)}}}),chisel.controller("homeController",function($scope,$rootScope){$scope.var="var is here"}),chisel.controller("launchController",function($scope,$rootScope,mainFactory,chisel_var){$scope.launch_step="create",$scope.var="var is here",$scope.fonts=chisel_var.get("fonts"),$scope.campaign_data={},$scope.amazon_connect("tappyn"),$scope.init=function(){$scope.campaign_data.font_color="#ffffff",$scope.campaign_data.cap_color="#ffffff"},$scope.init(),$scope.launch_step_create=function(){return"create"==$scope.launch_step},$scope.checkModel={front:!0,back:!1},$scope.launch_step_goal=function(){return"goal"==$scope.launch_step},$scope.launch_step_desc=function(){return"desc"==$scope.launch_step},$scope.set_step=function(step){$scope.launch_step=step},$scope.submit_campaign=function(data){mainFactory.launch_campaign(data).then(function(r){alert("Your campaign has been saved!")},$scope.handle_error)},$scope.refresh_bottle=function(){$("#bottle-div").css("font-family",$scope.campaign_data.font)},$scope.$on("amazon_uploaded",function(event){$scope.campaign_data.art=$scope.__s.aws.file_url})}),chisel.controller("mainController",function($scope,$rootScope,$upload,mainFactory){$scope.now_module="",$scope.template_v="1.4",$scope.__user={},$scope.__s={},$("body").on("click",".darken",function(event){event.target===this&&($scope.set_module(),$scope.$apply())}),$scope.set_module=function(name){$scope.now_module=name?name:""},$scope.register=function(data){mainFactory.register(data).then(function(r){$scope.__user=r.data.user,$scope.set_module()},$scope.handle_error)},$scope.handle_error=function(response){if(422==response.status){var data=response.data;for(var i in data)alert(data[i])}},$scope.is_login=function(){mainFactory.is_login().then(function(r){$scope.__user=r.data.user?r.data.user:{}})},$scope.is_login(),$scope.logout=function(){mainFactory.logout().then(function(r){$scope.__user={}},$scope.handle_error)},$scope.login=function(data){mainFactory.login(data).then(function(r){$scope.__user=r.data.user?r.data.user:{},$scope.set_module()},$scope.handle_error)},$scope.amazon_connect=function(bucket){mainFactory.aws_key(bucket).success(function(r){$scope.__s.aws=r})},$scope.amazon_upload=function($files,arg){arg=arg?arg:"";var aws=$scope.__s.aws,file=$files[0],url=aws.base_url,new_name=Date.now(),rando=Math.floor(1e5*Math.random());new_name="lo_"+arg+new_name.toString()+"_"+rando.toString(),$upload.upload({url:url,method:"POST",data:{key:new_name,acl:"public-read","Content-Type":null===file.type||""===file.type?"application/octet-stream":file.type,AWSAccessKeyId:aws.key,policy:aws.policy,signature:aws.signature},file:file}).success(function(){$scope.__s.aws.file_url=url+new_name,$scope.$broadcast("amazon_uploaded")})}}),chisel.factory("mainFactory",function($http){var fact={};return fact.register=function(data){return $http({method:"POST",url:"/register",headers:{"Content-type":"application/x-www-form-urlencoded"},data:$.param(data)})},fact.is_login=function(){return $http({method:"GET",url:"/is_login",headers:{"Content-type":"application/x-www-form-urlencoded"}})},fact.logout=function(){return $http({method:"GET",url:"/logout",headers:{"Content-type":"application/x-www-form-urlencoded"}})},fact.login=function(data){return $http({method:"POST",url:"/login",headers:{"Content-type":"application/x-www-form-urlencoded"},data:$.param(data)})},fact.launch_campaign=function(data){return $http({method:"POST",url:"/api/campaign/launch",headers:{"Content-type":"application/x-www-form-urlencoded"},data:$.param(data)})},fact.aws_key=function(bucket){return $http({method:"POST",url:"/api/amazon/get_token",headers:{"Content-Type":"application/x-www-form-urlencoded"},data:$.param({bucket:bucket})})},fact});
