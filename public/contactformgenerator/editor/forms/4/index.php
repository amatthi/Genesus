...
<title>My Contact Form copy</title>
...
<div class="cfgen-e-c">
	...
	<label class="cfgen-label" id="cfgen-element-4-3-label" ><span class="cfgen-label-value"></span><span class="cfgen-required">*</span></label>
	...
	<div class="cfgen-e-set" id="cfgen-element-4-3-set-c">
		<div class="cfgen-input-group" id="cfgen-element-4-3-inputgroup-c">
			<div class="cfgen-input-c" id="cfgen-element-4-3-input-c">
				<input type="text" class="cfgen-type-email cfgen-form-value " name="cfgen-element-4-3" id="cfgen-element-4-3" placeholder="Your Email Address">
			</div>
		</div>
	</div>
	...
	<div class="cfgen-e-set" id="cfgen-element-4-5-set-c">
		<div class="cfgen-input-group" id="cfgen-element-4-5-inputgroup-c">
			<div class="cfgen-input-c" id="cfgen-element-4-5-input-c">
				<input type="submit" class="cfgen-submit" name="cfgen-element-4-5" id="cfgen-element-4-5" value="Send">
			</div>
		</div>
	</div>
